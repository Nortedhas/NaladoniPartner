...
class CodeInputTextViewHolder(val constraintLayout: ConstraintLayout) :
    ...
    val textViewEnter by lazy {
        ...
        textView.text = "Введите цифровой код"
        textView
    }
    ...
    val textViewDescription by lazy {
        ...
        textView.text = "Попросите клиента продиктовать\nцифры под QR-кодом"
        textView
    }
...
fun CodeInputTextViewHolder.initialize() {
